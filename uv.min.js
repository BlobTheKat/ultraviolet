...
this.m|=1}uv(x=0,y=0,w=0,h=0,l=0){return{x:x/this.width,y:1-(y+h)/this.height,w:w/this.width,h:h/this.height,l,sub}}delete(){g.deleteTexture(this);if(P=this.u){P!=U&&g.activeTexture(33984+(U=P));P=U|(!this.layers<<4);this.u=-1;g.bindTexture(P<16?35866:3553,B[P]=null)}}}.prototype,X=t=>{const i=U|(!t.layers<<4),b=i<16?35866:3553;B[i]?(B[i].u=-1):B[i^16]&&g.bindTexture(39419-b,B[i^16]=null);t.u=U;g.bindTexture(b,B[i]=t);return b},F=Float32Array,V=[]
