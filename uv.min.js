...
this.m|=1}uv(x=0,y=0,w=0,h=0,l=0){return{x:x/this.width,y:1-(y+h)/this.height,w:w/this.width,h:h/this.height,l,sub}}delete(){g.deleteTexture(this);if(P=this.u){P!=U&&g.activeTexture(33984+(U=P));P=U|(!this.layers<<3);this.u=-1;g.bindTexture(P<8?35866:3553,B[P]=null)}}}.prototype,X=t=>{const i=U|(!t.layers<<3),b=i<8?35866:3553;B[i]?(B[i].u=-1):B[i^8]&&g.bindTexture(39419-b,B[i^8]=null);t.u=U;g.bindTexture(b,B[i]=t);return b},F=Float32Array,V=[]
N.Formats={R:[33321,6403,5121],RG:[33323,33319,5121],RGB:[32849,6407,5121],RGBA:D=[32856,P=6408,5121],RGB565:[36194,6407,33635],R11F_G11F_B10F:[35898,6407,35899],RGB5_A1:[32855,P,32820],RGB10_A2:[32857,P,33640],RGBA4:[32854,P,32819],RGB9_E5:[35901,6407,35902],R8:[33330,P=36244,5121],RG8:[33336,33320,5121],RGB8:[36221,36248,5121],RGBA8:[36220,36249,5121],R16:[33332,P,5123],RG16:[33338,33320,5123],RGB16:[36215,36248,5123],RGBA16:[36214,36249,5123],R32:[33334,P,5125],RG32:[33340,33320,5125],RGB32:[36209,36248,5125],RGBA32:[36208,36249,5125],R16F:[33325,P,5131],RG16F:[33327,33320,5131],RGB16F:[34843,36248,5131],RGBA16F:[34842,36249,5131],R16F_32F:[33325,P,5126],RG16F_32F:[33327,33320,5126],RGB16F_32F:[34843,36248,5126],RGBA16F_32F:[34842,36249,5126],R32F:[33326,P,5126],RG32F:[33328,33320,5126],RGB32F:[34837,36248,5126],RGBA32F:[34836,36249,5126]}
...
precision mediump float;precision highp int;in vec3 uv;in vec2 pos,xy;flat in float effect;flat in vec4 tint;out lowp vec4 color;uniform sampler2D tex0,tex1,tex2,tex3,tex4,tex5,tex6,tex7;uniform highp usampler2D utex0,utex1,utex2,utex3,utex4,utex5,utex6,utex7;uniform lowp sampler2DArray atex0,atex1,atex2,atex3,atex4,atex5,atex6,atex7;uniform highp usampler2DArray uatex0,uatex1,uatex2,uatex3,uatex4,uatex5,uatex6,uatex7;uniform highp vec4 u;uniform highp float s,t;
