...
this.#y=b;this.#z=c;this.#w=d}setST(s=0,t=0){this.#s=s;this.#t=t}clear(r=0,g=0,b=0,a=0){g.clearColor(r,g,b,a);L=(L&240)|(r==r)|(g==g)<<1|(b==b)<<2|(a==a)<<3;g.colorMask(L&1,L&2,L&4,L&8);let m=16384;const x=this.j,q=x?x.S=x.S+1&7:O=O+1&7;if(!q)m|=1024;g.stencilMask(1<<q);if(j!=x)g.bindFramebuffer(36160,j=x);const W=(j||g.canvas).width,H=(j||g.canvas).height;if(W|H){if(S!=W||T!=H)g.viewport(0,0,S=W,T=H);g.clear(m)}}clearColor(r=0,g=0,b=0,a=0){g.clearColor(r,g,b,a);L=(L&240)|(r==r)|(g==g)<<1|(b==b)<<2|(a==a)<<3
g.colorMask(L&1,L&2,L&4,L&8);if(j!=(j=this.j))g.bindFramebuffer(36160,j);const W=(j||g.canvas).width,H=(j||g.canvas).height;if(W|H){if(S!=W||T!=H)g.viewport(0,0,S=W,T=H);g.clear(16384)}}clearStencil(){const x=this.j,q=x?x.S=x.S+1&7:O=O+1&7;g.stencilMask(1<<q);if(!q){if(j!=x)g.bindFramebuffer(36160,j=x);const W=(j||g.canvas).width,H=(j||g.canvas).height;if(W|H){if(S!=W||T!=H)g.viewport(0,0,S=W,T=H);g.clear(1024)}}}draw(K,e,m=15,k=1135889,D=1e999){if(j!=(j=this.j))g.bindFramebuffer(36160,j);{const W=(j||g.canvas).width,A=(j||g.canvas).height
